    ...
    case 'search':
        if (isset($_POST['search']) && $_POST['search'] != '') {
            ...
            if (Config::get('Gmanager', 'addressBar')) {
                echo '<div><form action="?gmanager_action=change" method="get"><div><input type="text" name="c" value="' . $realpath . '"/><br/><input type="hidden" name="go" value="search"/><input type="submit" value="' . Language::get('go') . '"/></div></form></div>';
            }
