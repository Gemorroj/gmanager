...
class Helper_View
{
    public const MESSAGE_SUCCESS = 0;
    public const MESSAGE_ERROR = 1;
    public const MESSAGE_ERROR_EMAIL = 2;
    ...
    public static function urlHighlight($fl = '')
    {
        return \explode(
            ...
            \preg_replace(
                '/(&quot;|&#039;)[^<>]*(&quot;|&#039;)/iU',
                '<span style="color:#DD0000">$0</span>',
                \preg_replace(
                    '/&lt;!--.*--&gt;/iU',
                    '<span style="color:#FF8000">$0</span>',
                    \preg_replace(
                        '/(&lt;[^\s!]*\s)([^<>]*)([\/?]?&gt;)/iU',
                        '$1<span style="color:#007700">$2</span>$3',
                        \preg_replace(
                            '/&lt;[^<>]*&gt;/iU',
