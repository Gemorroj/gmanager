...
- Исправлена ошибка с импортом/аплоадом файлов
...
- Удалена поддержка php 5.2. Минимально поддерживаемая #### Версия php 5.3.9
...
- переписать интерфейс на vuejs... может быть, когда-нибудь...
